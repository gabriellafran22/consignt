...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<SearchHistoryDatabaseProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            ...
            body: provider.searchHistory.isEmpty
                ...
                : searchHistory(provider, searchController),
          );
        },
      ),
    );
...
Widget searchHistory(SearchHistoryDatabaseProvider provider,
            ...
            children: [
              ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    provider
                        .deleteSearchHistory(provider.searchHistory[index].id!);
                  },
                ),
                onTap: () {
                  searchController.text =
                      provider.searchHistory[index].searchQuery;
                  inject<Navigate>().navigateTo(
                    ScreenConst.searchResultScreen,
                    popPrevious: true,
                    arguments: {
